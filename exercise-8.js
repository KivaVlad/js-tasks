...
// Создал массив функций. Создал функцию composeFunctions, которая принимает массив функций. Эта функция создает замыкание, которое вызывает все переданные функции 
// методом forEach и возвращает результат их выполнения с помощью метода apply(). Полученные результаты выполнения функций пушим в пустой массив. 
// В результате возвращаем массив с результатами выполнения каждой функции 
